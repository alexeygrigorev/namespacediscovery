...
In logic, a \emph{formula} is defined recursively, and, in essence, it is a collection of variables, functions and other formulas. Formally, the symbols for the variables and functions can be chosen arbitrarily \cite{source:barwise02-logic}. However, in contrast to first order logic, in this work we are interested in the symbols in formulae and in mathematical notations that are used by different research communities. 
