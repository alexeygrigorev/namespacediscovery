...
%TODO: This need to be rewritten. Maybe you can intorduce the definition of a formula in FOL and
...
We aim to find \emph{meaningful} namespaces, in the sense that it can be related to a real-world area of knowledge, such as physics, linear algebra or statistics.
