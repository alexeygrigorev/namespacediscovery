...
Namespaces sind auch f\"ur Mathematik vorteilhaft. Durch die Einführung von Namespaces in der Mathematik, kann mann mathematische Identifikatoren in einer hierarchy organisieren.
...
Das kann mit Clustering-Algorithmen durchgeführt werden. Wir schlagen vor dass Dokumente repr\"a\-sentiert werden k\"onnen durch die Identifikatoren die sie enthalten. Dieser Ansatz ist \"ahnlich zu der Abbildung von Textinformationen in dem Vektorraummodell.
...
In die Experimenten suchen wir nach Algorithmen, die so viele reine Cluster wie möglich entdecken.
