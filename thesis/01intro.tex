...
%Finally, it gives a way to avoid am
%Additionally, it may give a way to avoid ambiguity. If we follow the XML approach 
% [11] and prepend namespace to the identifier, e.g. ``physics.E'', then it will 
% give additional context and make it clear that ``physics.$E$'' means ``energy'' 
