...
In mathematics and other sciences, the notation is a way of communicating between
scientists. \textbf{Expand this idea a bit} \cite{cajori1928history}.
More formally,  \emph{mathematical notation} is a system of naming identifiers in
...
However, mathematical notation does not yet exist in isolation, and it is usually
observed indirectly by its usage in documents. To account for this fact,
...
It is possible to do it manually by assigning each identifier/definition pair
...
\textbf{TODO: Why identifiers have similar properties}
Identifier names are used like words therefore we can make the same
assumptions about them (e.g. power law).
