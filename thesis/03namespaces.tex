...
We will consider Euclidean distance, inner product, cosine similarity and 
Jaccard coefficient.
...
Inverse Index to make the similarity search faster \cite{ertoz2003finding} \cite{manning2008introduction}.
