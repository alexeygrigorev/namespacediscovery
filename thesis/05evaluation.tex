...
We also repeat this experiment for Russian Wikipedia (table~\ref{tab:def-ru}), but 
...
\hline													
\end{tabular}}
\caption{Definitions for selected identifiers and namespaces extracted from English Wikipedia.}
\label{tab:def-en}
\end{table}
...
\hline													
\end{tabular}}
\caption{Definitions for selected identifiers and namespaces extracted from Russian Wikipedia.}
\label{tab:def-ru}
\end{table}
