...
$m$ (105\,000) and $n$ (83\,000), but about 3\,700 identifiers occur
...
For the 12\,771 the algorithm found 115\,300 definitions, and the
...
\caption{$K$ in $K$-Means vs the number of pure clusters: it grows initially, but after $K\approx 10\,000$ starts to decrease}
